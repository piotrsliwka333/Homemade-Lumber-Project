		...
		<section className='help' id='help'>
			...
			<div className='help__buttons'>
				...
				<a name='organizations' onClick={changeContent}
				   className={content === 'organizations' ? 'btn active-btn' : 'btn'}>Non-governmental <br/> organizations</a>
				<a name='collections' onClick={changeContent} className={content === 'collections' ? 'btn active-btn' : 'btn'}>Local <br/>collections</a>
			</div>
