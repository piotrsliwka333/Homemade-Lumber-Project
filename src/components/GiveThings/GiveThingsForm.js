...
import {
  GiveThingsFormButton,
  GiveThingsFormButtons,
} from "./GiveThingsFormButtons";
...
export const GiveThingsForm = () => {
  ...
  const handleNextStepCityValidation = (
    e,
    city,
    whoHelp,
    groupPeopleError,
    ...
    e.preventDefault();
    if (
      whoHelp.children === false &&
      whoHelp.singleMothers === false &&
      whoHelp.homeless === false &&
      whoHelp.disabled === false &&
      whoHelp.elderPeople === false
    ) {
    ...
    if (city === "Choose") {
      ...
      (whoHelp.children === true ||
        whoHelp.singleMothers === true ||
        whoHelp.homeless === true ||
        whoHelp.disabled === true ||
        whoHelp.elderPeople === true) &&
      cityError === false
    ) {
      setStep((prevState) => prevState + 1);
      setCityError(false);
  ...
  const handleNextStepPickUpDetailsValidation = (
    e,
    pickUpDetailsErrors,
    pickUpDetails
  ) => {
    e.preventDefault();
    if (
      pickUpDetailsErrors.street === true ||
      pickUpDetails.street.length === 0
    ) {
    ...
    if (
      pickUpDetailsErrors.postCode === true ||
      pickUpDetails.postCode.length === 0
    ) {
      setPickUpDetailsErrors((prevState) => {
        return {
          ...prevState,
    ...
    if (
      pickUpDetailsErrors.phoneNumber === true ||
    ...
    if (pickUpDetailsErrors.hour === true || pickUpDetails.hour.length === 0) {
      ...
      pickUpDetailsErrors.street === false &&
      pickUpDetailsErrors.city === false &&
      pickUpDetailsErrors.postCode === false &&
      pickUpDetailsErrors.postCode === false &&
      pickUpDetailsErrors.phoneNumber === false &&
      pickUpDetailsErrors.date === false &&
      pickUpDetailsErrors.hour === false
    ) {
      setStep((prevState) => prevState + 1);
    }
  };
  ...
  const style = {
    backgroundImage: `url('/assets/Background-Form.jpg')`,
  };
  ...
  return (
    <section className="things-form">
      ...
      <div className="things-form__wraper" style={style}>
        {step === 1 && (
          <GiveThingsFormOne
            currentType={typeOfThings}
            onType={handleChangeType}
          />
        )}
        {step === 2 && (
          <GiveThingsFormTwo
            setBagsAmountError={handleSetBagsError}
            bagsAmountError={bagsAmountError}
            onBagsAmount={bagsAmount}
            onBagsAmountFn={handleChangeBagsAmount}
          />
        )}
        {step === 3 && (
          <GiveThingsFormThree
            groupPeopleError={groupPeopleError}
            setCityError={handleSetCityError}
            cityError={cityError}
            organization={specificOrganization}
            onOrganization={handleSpecificOrganization}
            groupPeople={groupPeople}
            onGroupPeople={handleGroupPeople}
            onCity={city}
        ...
        {step === 4 && (
          <GiveThingsFormFour
            onTimeValidation={handleTimeValidation}
            onDateValidation={handleDateValidation}
            onNumberValidation={handleNumberValidation}
            onPostCodeValidation={handlePostCodeValidation}
            onCityValidation={handleCityValidation}
            onStreetValidation={handleStreetValidation}
            pickUpDetailsErrors={pickUpDetailsErrors}
            pickUpDetails={pickUpDetails}
            onPickUpDetails={handlePickUpDetails}
          />
        )}
        {step === 5 && (
          <GiveThingsFormSummary
            pickUpDetails={pickUpDetails}
            location={city}
            target={groupPeople}
          />
        ...
        <GiveThingsFormButtons>
          ...
          {step === 2 && (
            <>
              <GiveThingsFormButton
                argument={bagsAmount}
                actionClick={handleNextStepBagsValidation}
                name="Next"
              />
          ...
          {step === 3 && (
            <>
              <GiveThingsFormButton
                argumentFour={groupPeopleError}
                argumentThree={cityError}
                argumentTwo={groupPeople}
                argument={city}
                actionClick={handleNextStepCityValidation}
                name="Next"
              />
              <GiveThingsFormButton actionClick={handlePrevStep} name="Back" />
            </>
          ...
          {step === 4 && (
            <>
              <GiveThingsFormButton
                argumentTwo={pickUpDetails}
                argument={pickUpDetailsErrors}
                actionClick={handleNextStepPickUpDetailsValidation}
                name="Next"
              />
              <GiveThingsFormButton actionClick={handlePrevStep} name="Back" />
            </>
          ...
          {step === 5 && (
            <>
              <GiveThingsFormButton actionClick={handlePrevStep} name="Back" />
              <GiveThingsFormButton
                argument={typeOfThings}
                argumentTwo={bagsAmount}
                argumentThree={city}
                argumentFour={groupPeople}
                argumentFive={pickUpDetails}
                actionClick={saveMessage}
                name="Confirm"
              />
            </>
          )}
