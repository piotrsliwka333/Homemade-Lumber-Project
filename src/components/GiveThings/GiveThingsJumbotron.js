...
const GiveThingsJumbotronSteps = (props) => {
  return <div className="things-jumbotron__steps">{props.children}</div>;
};
...
const GiveThingsJumbotronStepsElement = (props) => {
  ...
  return (
    <div className="things-jumbotron__steps__element">
      <p className="things-jumbotron__steps__element-text">
...
export const GiveThingsJumbotron = () => {
  const style = {
    backgroundImage: `url('/assets/Form-Hero-Image.jpg')`,
  };
  return (
      ...
      <div className="container">
        <div className="row">
          <div className="col-11 col-md-8 col-xl-6 box">
            ...
            <img
              className="things-jumbotron__decoration"
              src="/assets/Decoration.svg"
            />
            <h2 className="things-jumbotron__subtitle">
              4 Simple Steps Are Enough
            </h2>
            <GiveThingsJumbotronSteps>
              <GiveThingsJumbotronStepsElement
                name="Choose things"
                number="1"
              />
              <GiveThingsJumbotronStepsElement
              ...
              />
              <GiveThingsJumbotronStepsElement
                name="Choose Foundation"
                number="3"
              />
              <GiveThingsJumbotronStepsElement
                name="Order a courier"
                number="4"
              />
            </GiveThingsJumbotronSteps>
          </div>
